...
const logDefinitions = [
  { file: 'anchorage_full.json', location: '허상의 정박지 매우 어려움', condition: '잊힌 맹약 장착', group: 'anchorage', reference: 'https://mobi-score.com/r/4Qq19MnzmZiC0a7e' },
  { file: 'anchorage_without_head.json', location: '허상의 정박지 매우 어려움', condition: '머리·잊힌 맹약 제거', group: 'anchorage', reference: 'https://mobi-score.com/r/WKx26orrtszkzEME' },
  { file: 'cave_full.json', location: '광기의 동굴 매우 어려움', condition: '잊힌 맹약 장착', group: 'cave', reference: 'https://mobi-score.com/r/PeFuIadiNfJVC4sA' },
  { file: 'cave_without_head.json', location: '광기의 동굴 매우 어려움', condition: '머리·잊힌 맹약 제거', group: 'cave', reference: 'https://mobi-score.com/r/1AjC9mmQJHCSw8bD' },
  { file: 'waterway_full.json', location: '흩어진 물길 매우 어려움', condition: '잊힌 맹약 장착', group: 'waterway', reference: 'https://mobi-score.com/r/uOSkrIy94NhcZfH8' },
  { file: 'waterway_without_head.json', location: '흩어진 물길 매우 어려움', condition: '머리·잊힌 맹약 제거', group: 'waterway', reference: 'https://mobi-score.com/r/TU0xlhPHmWCBWjCP' },
  { file: 'kabrak_full_1.json', location: '카브락 입문', condition: '잊힌 맹약 장착', group: 'kabrak', reference: 'https://mobi-score.com/r/qEfbzhpgazVcqm2N' },
  { file: 'kabrak_full_2.json', location: '카브락 입문', condition: '잊힌 맹약 장착', group: 'kabrak', reference: 'https://mobi-score.com/r/vGjwTiRp7FlNDokk' },
  { file: 'kabrak_without_head.json', location: '카브락 입문', condition: '머리·잊힌 맹약 제거', group: 'kabrak', reference: 'https://mobi-score.com/r/HlrVreU9CzMZwmlt' },
];
...
function buildReport(observations, comparisons) {
  ...
  const sourceRows = observations.map((entry, index) => `[${index + 1}]: ${entry.reference} "${entry.location} · ${entry.condition} 공개 전투 기록"`).join('\n');
