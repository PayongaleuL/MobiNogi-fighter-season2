...
const logDefinitions = [
  { file: 'anchorage_full.json', content: '룬다 어비스 매우 어려움', target: '칼드레드 · 허상의 정박지 매우 어려움', condition: '장착', analysisId: 'LEGACY-A01' },
  { file: 'anchorage_without_head.json', content: '룬다 어비스 매우 어려움', target: '칼드레드 · 허상의 정박지 매우 어려움', condition: '제거', analysisId: 'LEGACY-A02' },
  { file: 'cave_full.json', content: '룬다 어비스 매우 어려움', target: '데스펠 · 광기의 동굴 매우 어려움', condition: '장착', analysisId: 'LEGACY-A03' },
  { file: 'cave_without_head.json', content: '룬다 어비스 매우 어려움', target: '데스펠 · 광기의 동굴 매우 어려움', condition: '제거', analysisId: 'LEGACY-A04' },
  { file: 'waterway_full.json', content: '룬다 어비스 매우 어려움', target: '테로사 · 흩어진 물길 매우 어려움', condition: '장착', analysisId: 'LEGACY-A05' },
  { file: 'waterway_without_head.json', content: '룬다 어비스 매우 어려움', target: '테로사 · 흩어진 물길 매우 어려움', condition: '제거', analysisId: 'LEGACY-A06' },
  { file: 'kabrak_full_1.json', content: '카브락 입문', target: '카브락 · 입문', condition: '장착', analysisId: 'LEGACY-A07' },
  { file: 'kabrak_full_2.json', content: '카브락 입문', target: '카브락 · 입문', condition: '장착', analysisId: 'LEGACY-A08' },
  { file: 'kabrak_without_head.json', content: '카브락 입문', target: '카브락 · 입문', condition: '제거', analysisId: 'LEGACY-A09' },
];
